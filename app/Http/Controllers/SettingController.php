...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'default_printer' => 'required|in:browser,bluetooth',
            'enable_shift' => 'required|boolean',
        ]);

        $data = $request->only(['store_name', 'store_address', 'store_phone', 'store_description', 'tax_rate', 'paper_size', 'default_printer', 'enable_shift']);
