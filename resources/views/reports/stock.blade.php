                            ...
                            <div class="bg-white rounded-xl shadow-md border {{ $product->total_stock <= 0 ? 'border-red-300' : ($product->total_stock <= $product->minimum_stock ? 'border-yellow-300' : 'border-gray-200') }} p-4">
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-200 text-sm space-y-2">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <p class="font-medium {{ $difference < 0 ? 'text-red-600' : ($difference == 0 ? 'text-yellow-600' : 'text-green-600') }}">{{ $difference >= 0 ? '+' : '' }}{{ (float)$difference }}</p>
                                    </div>
