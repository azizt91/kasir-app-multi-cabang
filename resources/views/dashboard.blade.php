                ...
                <div class="p-6 bg-gradient-to-r from-yellow-500 to-orange-500 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="text-2xl sm:text-3xl font-bold text-white animate-number" data-value="{{ (float)$stats['low_stock_products'] }}">{{ (float)$stats['low_stock_products'] }}</div>
                    ...
                    <div class="space-y-4" style="max-height: 400px; overflow-y: auto;">
                        @forelse($low_stock_products as $product)
                            <div class="flex items-center justify-between p-4 bg-red-50 rounded-xl border border-red-100">
                                ...
                                <div class="text-right">
                                    <p class="text-sm font-bold text-red-600">{{ (float)$product->stock }}</p>
                                ...
                                @forelse($top_products as $index => $product)
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="text-sm font-bold text-gray-900">{{ (float)($product->total_sold ?? 0) }} units</div>
                            ...
                            <div class="bg-white rounded-xl shadow-md border border-gray-200 p-4">
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-200 grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900">{{ (float)($product->total_sold ?? 0) }} unit</p>
                                    </div>
                                    <div class="text-right">
