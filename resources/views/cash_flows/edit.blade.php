...
<div class="bg-gray-50 min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Edit Arus Kas</h1>
                <p class="text-gray-500 mt-1">Perbarui detail mutasi kas manual untuk menjaga akurasi laporan.</p>
            </div>
        </div>

        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="p-1 bg-gradient-to-r from-indigo-500 to-purple-600"></div>
            <form action="{{ route('cash-flows.update', $cashFlow) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <input type="date" name="date" id="date" value="{{ $cashFlow->date->format('Y-m-d') }}" required
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="relative border border-gray-300 rounded-lg cursor-pointer transition-colors hover:bg-emerald-50 has-[:checked]:border-emerald-500 has-[:checked]:bg-emerald-50 has-[:checked]:text-emerald-700 flex items-center justify-center py-3">
                                    <input type="radio" name="type" value="in" {{ $cashFlow->type === 'in' ? 'checked' : '' }} class="sr-only">
                                ...
                                <label class="relative border border-gray-300 rounded-lg cursor-pointer transition-colors hover:bg-rose-50 has-[:checked]:border-rose-500 has-[:checked]:bg-rose-50 has-[:checked]:text-rose-700 flex items-center justify-center py-3">
                                    <input type="radio" name="type" value="out" {{ $cashFlow->type === 'out' ? 'checked' : '' }} class="sr-only">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative shadow-sm rounded-lg">
                                ...
                                <input type="text" name="category" id="category" value="{{ $cashFlow->category }}" required
                                       class="block w-full pl-10 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all sm:text-sm">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-xl shadow-sm group">
                                ...
                                <input type="number" name="amount" id="amount" step="0.01" value="{{ $cashFlow->amount }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="note" id="note" rows="4"
                                  ...
                                  placeholder="Tuliskan keterangan detail di sini...">{{ $cashFlow->note }}</textarea>
